...
public class FilteredTree extends Composite {
	...
	private static String FilteredTree_AccessibleListenerFiltered="{0} {1} matches";
	private static String FilteredTree_FilterMessage = "Type filter text";
	private static String FilteredTree_AccessibleListenerClearButton="Clear filter field";
    /**
        ...
        this.filterText.getAccessible().addAccessibleListener(new AccessibleAdapter() {
            ...
            public void getName(AccessibleEvent e) {
                ...
                if (filterTextString.length() == 0 || filterTextString.equals(FilteredTree.this.initialText)) {
                    ...
                    e.result = NLS.bind(FilteredTree_AccessibleListenerFiltered, new String[] { filterTextString, String.valueOf(getFilteredItemsCount()) });
                }
            }
    ...
    protected void textChanged() {
        this.narrowingDown = this.previousFilterText == null || this.previousFilterText.equals(FilteredTree_FilterMessage) || getFilterString().startsWith(this.previousFilterText);
