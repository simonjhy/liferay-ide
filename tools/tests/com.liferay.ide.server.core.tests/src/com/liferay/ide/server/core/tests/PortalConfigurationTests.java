...
public class PortalConfigurationTests extends ServerCoreBase
{
    ...
    public void testGetPortalServerConfigurationForNewTomcatServer() throws Exception
    {
        ...
        LiferayServerPort agentPort = new LiferayServerPort(
            ILiferayServer.ATTR_AGENT_PORT, "Bnd Agent", 27998, "TCPIP", LiferayServerPort.defaultStoreInServer );
    ...
    public void testGetPortalServerConfigurationForExistedTomcatServer() throws Exception
    {
        ...
        LiferayServerPort agentPort = new LiferayServerPort(
            ILiferayServer.ATTR_AGENT_PORT, "Bnd Agent", 27997, "TCPIP", LiferayServerPort.defaultStoreInServer );
        LiferayServerPort httpPort =
    ...
    public void testGetPortalServerConfigurationForNewWildfly() throws Exception
    {
        ...
        LiferayServerPort agentPort = new LiferayServerPort( ILiferayServer.ATTR_AGENT_PORT, "Bnd Agent", 27996, "TCPIP", LiferayServerPort.defaultStoreInServer );
    ...
    public void testGetPortalServerConfigurationForExistedWildfly() throws Exception
    {
        ...
        LiferayServerPort agentPort = new LiferayServerPort( ILiferayServer.ATTR_AGENT_PORT, "Bnd Agent", 27995, "TCPIP", LiferayServerPort.defaultStoreInServer );
