...
//					IMarker marker = new Marker(CoreUtil.getWorkspace().getRoot().getProject("aaaa"),1);
//
//					IMarkerResolution[] resolutions = IDE.getMarkerHelpRegistry().getResolutions(marker);
//
//					if (ListUtil.isNotEmpty(resolutions)) {
