...
public class UpgradeView extends ViewPart
{
    ...
    public void createPartControl( Composite parent )
    {
        ...
        UpgradePage[] pages = { new DescriptionUpgradePage(composite1,SWT.BORDER), new DescriptionUpgradePage(composite2,SWT.BORDER)};
        final NavigatorControl nav = new NavigatorControl( composite, SWT.BORDER,pages );
