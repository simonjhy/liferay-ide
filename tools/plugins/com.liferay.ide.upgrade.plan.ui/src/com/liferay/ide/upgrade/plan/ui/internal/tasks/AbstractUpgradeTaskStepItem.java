...
public abstract class AbstractUpgradeTaskStepItem implements IExpansionListener, UpgradeTaskItem {
	...
	public AbstractUpgradeTaskStepItem(
		...
		final Composite itemComposite = createComposite(
	...
	protected Composite createComposite(FormToolkit formToolkit, Composite parent, int columns, int hspan, int fill) {
