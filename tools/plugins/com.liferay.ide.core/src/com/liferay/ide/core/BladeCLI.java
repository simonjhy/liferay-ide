...
public class BladeCLI {
	...
	private static IPath _getBladeJarFromBundle() throws IOException {
		LiferayCore projectCore = LiferayCore.getDefault();
	...
	private static final IPath _bladeJarInstanceArea = LiferayCore.getDefault().getStateLocation().append("blade-jar");
	private static final IPath _bladeJarInstancePath = _bladeJarInstanceArea.append(BLADE_JAR_FILE_NAME);
	private static final IEclipsePreferences _defaultPrefs = DefaultScope.INSTANCE.getNode(LiferayCore.PLUGIN_ID);
	private static final IEclipsePreferences _instancePrefs = InstanceScope.INSTANCE.getNode(LiferayCore.PLUGIN_ID);
