		...
		public int compare(String a, String b) {
			if (a.startsWith("dxp") && !b.startsWith("dxp")) {
				...
				if (CoreUtil.isNullOrEmpty(aProductMicroVersion)) {
					...
					try {
						int bMicroVersionInt = Integer.parseInt(bMicroVersionString);
						int aMicroVersionInt = Integer.parseInt(aMicroVersionString);

						return bMicroVersionInt - aMicroVersionInt;
					}
