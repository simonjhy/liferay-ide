...
@Component(
	...
	property = {
		...
		"javax.portlet.display-name=${componentNameWithoutTemplateName}BladeDocumentAction Portlet",
		"javax.portlet.security-role-ref=power-user,user"
	},
	service = Portlet.class
)
public class ${componentNameWithoutTemplateName}BladeDocumentActionPortlet extends GenericPortlet {
