 ...
 * @author liferay
 */
public class ${componentNameWithoutTemplateName}BladeActionDisplayContext
	extends BaseDLViewFileVersionDisplayContext {

	public ${componentNameWithoutTemplateName}BladeActionDisplayContext(
	...
	private static final Log _log = LogFactoryUtil.getLog(
		${componentNameWithoutTemplateName}BladeActionDisplayContext.class);
