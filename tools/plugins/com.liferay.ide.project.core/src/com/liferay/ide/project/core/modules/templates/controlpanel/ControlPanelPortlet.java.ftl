...
@Component(
	...
	property = {
		...
		"javax.portlet.name=${componentNameWithoutTemplateName}_blade_portlet_ControlPanelAppPortlet"
	},
	service = Portlet.class
)
public class ${componentNameWithoutTemplateName}ControlPanelPortlet extends FreeMarkerPortlet {
