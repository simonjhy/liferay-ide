...
public class PortalDockerRuntimeComposite extends Composite implements ModifyListener {
	...
	public PortalDockerRuntimeComposite(Composite parent, IWizardHandle wizard) {
	...
	private static class Msgs extends NLS {
		...
		static {
			initializeMessages(PortalDockerRuntimeComposite.class.getName(), Msgs.class);
		}
