	...
	public void exit() {
		...
		if (servers.length > 1) {
			LiferayServerUI.logWarning(
				"The runtime selected already has server(s), you shouldn't make multiple servers point to the same " +
					"runtime if you want to launch multiple servers in IDE at one time");
		}
	}
