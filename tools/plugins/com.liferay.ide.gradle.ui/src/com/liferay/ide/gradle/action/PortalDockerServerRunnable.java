...
* @author Simon Jiang
*/
public abstract class PortalDockerServerRunnable implements IRunnableWithProgress {

	public PortalDockerServerRunnable(String jobName) {
		_jobName = jobName;
	}
	...
	private String _jobName = "Liferay Docker Job " + _generateId();
