 ...
 * @author Simon Jiang
 */
public class BladeServerOutputStreamMonitor implements IFlushableStreamMonitor {

	public BladeServerOutputStreamMonitor() {
	...
	private class StreamNotifier implements ISafeRunnable {
		...
		public void run() throws Exception {
			_listener.streamAppended(_text, BladeServerOutputStreamMonitor.this);
		}
