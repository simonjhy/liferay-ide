...
public class ServerWildflyTests extends SwtbotBase {
	...
	public static void prepareServer() throws IOException {
		...
		IPath serverDir = envAction.getServerDirWildfly();

		IPath fullServerDir = serverDir.append(envAction.getServerNameWildfly());
	...
	public void addLiferay7RuntimeFromPreferences() {
		...
		wizardAction.newRuntime7.prepare(runtimeName, envAction.getServerFullDirWildfly().toOSString());
